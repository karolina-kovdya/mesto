export default class FormValidator {
    ...
    constructor(validationConfig, formElement) {
        ...
        this.#inputList = Array.from(this.#formElement.querySelectorAll(this.#validationConfig.inputSelector));
        this.#button = this.#formElement.querySelector(this.#validationConfig.submitButtonSelector)
    }
