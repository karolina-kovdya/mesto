...
export const popupElementChange = '.popup_change-avatar';
export const popupElementDelete = '.popup_delete-card';
...
export const popupChange = document.querySelector(".profile__avatar")
